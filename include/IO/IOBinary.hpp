...
/**
 * @namespace quantkos::IO::Binary
 * @brief Provides high-performance, compact binary serialization for simulation path data.
 *
 * @details This namespace implements the `quantkos::IO` blueprints using a custom binary format designed
 ...
 * - Magic Key (`'QuantKos'`) for file validation.
...
namespace quantkos::IO::Binary {
     ...
     * that the binary data is valid, was generated by QuantKos, and uses the correct number
    ...
    private:
         ...
         * @throw std::runtime_error If the file fails to open, if the file signature does not match "QUANTKOS",
